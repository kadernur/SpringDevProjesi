...
import kodlama.io.Devs.business.rules.ValidationProblemsDetails;
...
public class DevsApplication {
	...
	//uygulama açıldığında modelmapper üretmesini sağlayan kod
		...
		@ExceptionHandler
		@ResponseStatus(code = HttpStatus.BAD_REQUEST)
		public ValidationProblemsDetails handleValidationException(MethodArgumentNotValidException methodArgumentNotValidException) {
